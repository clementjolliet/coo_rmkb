...
public class Cabine {
	...
	public EEtatCabine getEtatCabine(){
	 ...
	 public Etage getEtage(){ // Rajout� uniquement pour pouvoir print certains messages
		 return this.etageCourant;
	 }
	 
	 private void setEtage(Etage nouvelEtage){ // Correspond sur les diagrammes de conception � la m�thode metAJour
