...
public class AscenceurTest {
	...
	public static void main(String[] args) {
		...
		// instanciation des �tages
		
		Etage etage0 = new Etage(0, leGestionnaireServices); // A rajouter dans gestionnaireService la m�thode qui l'enregistre dans l'attribut de l'�tage
